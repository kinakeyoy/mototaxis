            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav  nav-tabs mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link active" href="encuestador1.php">
                            <h5>Nuevo</h5>
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="consultaencuestador.php"><h5>Consulta</h5></a>
                    </li>               
                    <li class="nav-item">
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="cargarencuestador.php" method="POST">
            <fieldset>
